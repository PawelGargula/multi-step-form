            ...
            <div className="radio-button">
                <div>
                    ...
                    <label className="radio-input" htmlFor="arcade">
                        <img src={arcadeIcon} alt="arcade plan icon" width={40} height={40} />
                ...
                <div>
                    ...
                    <label className="radio-input" htmlFor="advanced">
                        <img src={advancedIcon} alt="advanced plan icon" width={40} height={40} />
                        <div className="plan-info">
                            <span>Advanced</span>
                            {watch("isYearly") 
                ...
                <div>
                    ...
                    <label className="radio-input" htmlFor="pro">
                        <img src={proIcon} alt="pro plan icon" width={40} height={40} />
                        <div className="plan-info">
                            <span>Pro</span>
                            {watch("isYearly") 
